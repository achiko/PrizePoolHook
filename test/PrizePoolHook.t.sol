...
import {PrizePoolHook} from "../src/PrizePoolHook.sol";

contract TestPrizePoolHook is Test, Deployers {
	...
	function setUp() public {
        ...
        deployCodeTo(
            "PrizePoolHook.sol",
            abi.encode(manager, "Tickets Token", "TKT"),
            address(flags)
        );

        // Deploy our hook
        hook = PrizePoolHook(address(flags));
